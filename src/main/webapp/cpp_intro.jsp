...
<div class="main-content">
    ...
    <div class="content-section" id="intro">
        ...
        <p>C++ is a powerful general-purpose programming language. It is widely used for developing system software, games, real-time applications, and high-performance applications.</p>
        
        <p><strong>Why Use C++?</strong></p>
        <ul>
            <li>High-performance: Used in game engines, operating systems, and real-time simulations.</li>
            <li>Object-oriented: Supports OOP concepts like inheritance, encapsulation, and polymorphism.</li>
            <li>Extensive library support: Includes the Standard Template Library (STL) for efficient algorithms and data structures.</li>
        </ul>
    ...
    return 0;
        ...
        <div class="video-container">
            <a href="https://www.youtube.com/watch?v=vLnPwxZdW4Y" target="_blank">
                <img src="https://img.youtube.com/vi/vLnPwxZdW4Y/0.jpg" alt="C++ Introduction Video">
            </a>
        </div>
    </div>

    <div class="button-container">
        <a href="cpp_subject.jsp" class="quiz-btn">Take Quiz</a>
    </div>
    <div class="button-container2">
        <a href="cpp_datatypes.jsp" class="quiz-btn">NEXT</a>
    </div>
</div>
