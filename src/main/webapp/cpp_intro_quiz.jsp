...
<head>
    <meta charset="UTF-8">
    <title>C++ Introduction Quiz</title>
    <script>
...
<body onload="startTimer()">
    <div class="container">
        <h2>C++ Introduction Quiz</h2>
        <h3 id="timer"></h3>

        <form id="quizForm" action="ExamServlet" method="post">
            <%
                ...
                try {
                    ...
                    ps = conn.prepareStatement("SELECT * FROM questionsd WHERE subject='cppintro'");
                    rs = ps.executeQuery();
        ...
        <div class="footer">
            <p>Good luck with your quiz! Time is ticking!</p>
        </div>
    </div>
</body>
</html>